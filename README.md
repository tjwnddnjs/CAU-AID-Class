...
```
## Notes
- Ensure that the input for predictions is numeric and follows the correct format (valu1, value2).
- Modify project dataset loading path in the script if necessary.
